        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                children: [
                  Text(Constants.salutationsTitle, style: MyTextStyle.subTitle.copyWith(color: Colors.white)),
                  Text("${Constants.total} 12,800",
                  ...
                  Builder(builder: (context) {
                    var text =
                        Constants.lastEntries.replaceFirst("___", "15");
                    return Text("($text)",
                  ...
                  Container(
                      ...
                      child: Text("${Constants.lastUpdate} : 2024-04-12 11:49PM",
                  ...
                  return InkWell(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        border:selectedIndex == index ? Border.all(color:MyColors.colorPrimary,width: 1.0):null,
                      ),
                      child: Row(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        mainAxisAlignment: MainAxisAlignment.start,
                            ...
                            child: Column(
                              ...
                              children: [
                                Container(
                                  ...
                                  child:Text("2,000", style: MyTextStyle.subTitle.copyWith(color: MyColors.colorPrimary)),
                                ...
                                Container(
                                  ...
                                  child:Text("2,000", style: MyTextStyle.subTitle.copyWith(color: MyColors.colorBlue)),
                                ),
                                const SizedBox(height: 5.0,),
                                Text("10.81 %", style: MyTextStyle.subTitle),
                                const SizedBox(height: 10.0,),
                                Text("2024-04-12 11:49PM", style: MyTextStyle.text)
